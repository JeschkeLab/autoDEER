...
class autoDEERUI(QMainWindow):
    ...
    def update_deer_settings(self, remaining_time=None, threaded=False):
        """
        ...
        if threaded:
            ...
            self.update_pulses(func(remaining_time))
        

    def _update_single_deer_settings_and_pulses(self, remaining_time=None):
        """
    ...
    def _update_deer_settings_and_pulses(self,remaining_time=None):
